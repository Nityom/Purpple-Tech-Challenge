#!/usr/bin/env bash
# run.sh — Process all CCTV clips for Brigade_Bangalore and feed events to the API.
#
# Usage:
#   ./pipeline/run.sh [--api-url http://localhost:8000] [--frame-step 3]
#
# Prerequisites:
...
VIDEO_DIR="$ROOT_DIR/CCTV Footage"
...
# ---------------------------------------------------------------------------
# Camera mapping: parallel arrays (compatible with bash 3.2 on macOS)
# ---------------------------------------------------------------------------
CAM_FILES=("CAM 1.mp4" "CAM 2.mp4" "CAM 3.mp4" "CAM 4.mp4" "CAM 5.mp4")
